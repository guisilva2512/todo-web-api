...
namespace Todo.Domain.Api.Controllers
{
    ...
    public class TodoController : ControllerBase
    {
        ...
        [Route("done/tomorrow")]
        [HttpGet]
        public IEnumerable<TodoItem> GetDoneForTomorrou([FromServices] ITodoRepository repository)
        {
            var user = User.Claims.FirstOrDefault(x => x.Type == "user_id")?.Value;
        ...
        [HttpGet]
        public IEnumerable<TodoItem> GetUndoneForTomorrou([FromServices] ITodoRepository repository)
        {
            var user = User.Claims.FirstOrDefault(x => x.Type == "user_id")?.Value;
